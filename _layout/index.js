...
<body>
    ...
    <main>
        ...
        <div id="itemsContainer">
            ...
            <div id="calendarContainer" class="itemsContainer" style="display:none;">
                <div>
                <nav id="cal-nav" class="navbar">
                    <select name="view" id="view-selection">
                    <option value="day">Day</option>
                    <option value="week">Week</option>
                    <option value="month" selected>Month</option>
                    </select>
                    <button id="today" class="button is-rounded today">Today</button>
                    <button id="prev" class="button is-rounded prev"><</button>
                    <button id="next" class="button is-rounded next">></button>
                    <span id="navbar--range" class="navbar--range"></span>
                </nav>
                </div>
                <div id="calendar"></div>
            </div>
